...
*You don't need to derive anything - use the equation given. Some baseline values to start from: L = 1.0 m, g = 9.81 m/s², m = 1.0 kg, b = 0.5 s⁻¹. The drive amplitude A and frequency ω are yours.*

*Build something in Python that simulates this system and explore its behavior. We've left the brief open on purpose — how you approach it is up to you.*
...
The code was developed by Belinda Mellish using WSL2 on a Windows machine. 
